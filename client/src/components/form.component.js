        ...
        return (
            <form className='form-inline row' onSubmit={this.handleSubmit}>
                <div className=' form-group'>
                    <label> Topic: <input className='form-control' required type="text" value={this.state.query}
                                          onChange={this.handleChange} name='query'/> </label>
                </div>
                <div className='form-group'>
                    <label> From: <input className='form-control' required type="date" value={this.state.dateFrom}
                                         onChange={this.handleChange} name='dateFrom'/></label>
                </div>
                <div className='form-group'>
                    <label> To: <input className='form-control' required type="date" value={this.state.dateTo}
                                       onChange={this.handleChange} name='dateTo'/> </label>
                </div>
